...
namespace Nodes.Core.Editor
{
    /// <summary>
    /// Placeholder
    /// TODO: A class for graph editors to store editor only properties for any <see cref="ReferencedType"/> in a graph, or on a graph itself.
